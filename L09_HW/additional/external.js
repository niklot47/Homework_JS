...
for (let user of usersList) {
    ...
    let userNameSurname = document.createElement('div');
    userNameSurname.classList.add('userNameSurname');
    userNameSurname.innerText = user.name;
    let email = document.createElement('div');
    email.classList.add('email');
    email.innerText = user.email;

    let addressGeo = document.createElement('div');
    addressGeo.classList.add('addressGeo');
    let address = document.createElement('div');
    address.classList.add('address');
    let cityZip = document.createElement('div');
    cityZip.classList.add('cityZip');
    ...
    street.innerText = user.address.street + '   street';
    ...
    cityZip.appendChild(city);
    cityZip.appendChild(zipcode);
    address.appendChild(cityZip);
    address.appendChild(street);
    address.appendChild(suite);
    addressGeo.appendChild(address);
    geo.appendChild(lat)
    geo.appendChild(lng)
    addressGeo.appendChild(geo);
    userCard.appendChild(userName);
    userCard.appendChild(userNameSurname);
    userCard.appendChild(email);
    userCard.appendChild(addressGeo);
