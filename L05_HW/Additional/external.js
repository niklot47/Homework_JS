...
// Так вийшло, що наступні 2 завдання я зробив ще на попередню ДЗ, тому я просто зкопіюю їх (без змін, строгого завдання
// переробити на стрілочні тут ніби не стоїть)
